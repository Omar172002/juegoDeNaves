...
public class SpawnFollowPlayer : MonoBehaviour
{
    ...
    public float distancia = 5.0f; // La distancia en el eje Y a la que el objeto "spawn" seguirá al jugador.
    ...
    void Update()
    {
        ...
        Vector3 posicionObjetoSpawn = new Vector3(transform.position.x, jugador.position.y + distancia, transform.position.z);
